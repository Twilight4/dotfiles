...
- [[#tips-and-tricks][Tips and Tricks]]
  ...
  - [[#system-config-and-installation-on-wayland---hyprland-wm][System config and installation on Wayland - *Hyprland* WM]]
...
** System config and installation on Wayland - *Hyprland* WM
