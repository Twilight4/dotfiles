...
| C-k/j      | Up/down line or history               |
| C-S-j/k    | Scroll line down/up                   |
| C-a/e      | Beginning/end of line                 |
| C-p/n      | Cycle through autosuggestions history |
| C-f/b      | Forward/backward word                 |
| S-TAB      | Dismiss current autosuggestion        |
| C-SPC      | Selection mode                        |
| C-w        | Backward kill word                    |
| M-d        | Forward kill word                     |
| C-u        | Backward kill line                    |
| C-o        | Forward kill line                     |
| C-g        | Clear screen                          |
| M-'        | Quote region                          |
| M-/        | Which command                         |
...
| C-/        | Toggle preview                |
| C-j/C-k    | Down/up line                  |
| C-q/C-o    | Preview down/up line          |
| C-f/C-b  | Half page up/down             |
| M-d/M-u    | Preview half page up/down     |
| TAB        | Multi-select                  |
...
| A          | Create files/dirs simultaneously    |
| SPC        | Mark/Unmark                          |
...
| Keybinding | Description                                                     |
|------------+-----------------------------------------------------------------|
| ,          | Sort options (default alphabetically)                           |
| .          | Toggle hidden files                                             |
| //?        | Find next/backwards                                             |
...
| C          | Chmod on selected files                    |
| gm         | Show git file changes                      |
| F          | Enter smart filter plugin                  |
...
| J/K/SPC/S-SPC | scroll page up/down           |
| gg/G/nG       | go to page                    |
| P             | snaps to current page         |
| o/i           | backward/forward in jump list |
| o-TAB         | open document                 |
| D             | column/dual page              |
...
| C-M-k      | Close all unpinned tabs  |
| C-S-d      | Toggle pin tab           |
...
** Extensions
| Proton Pass | Description                         |
|-------------+-------------------------------------|
| C-S-l       | Open Proton Pass in a larger window |
| C-S-y       | Open the Proton Pass popup          |
