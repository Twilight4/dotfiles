...
alias dw='cd "$HOME/downloads" ; clear ; y'
alias dt='cd "$HOME/desktop" ; clear ; y'
alias pc='cd "$HOME/pictures" ; clear ; y'
alias sc='cd "$HOME/pictures/screenshots" ; clear ; fimg'
alias vd='cd "$HOME/videos" ; clear ; y'
alias mc='cd "$HOME/music" ; clear ; y'
alias dc='cd "$HOME/documents" ; clear ; y'
alias org='cd "$HOME/documents/org" ; clear ; y'
alias sv='cd "$HOME/desktop/server" ; clear ; y'
alias pj='cd "$HOME/desktop/projects" ; clear ; y'
alias ws='cd "$HOME/desktop/workspace" ; clear ; y'
# MEGA dirs
...
alias ompc='omp commit --model=zai/glm-4.7'
...
alias parsyur="~/.config/.local/bin/sys-update.sh && sleep 5 && reboot"        # Update and reboot
alias parsyus="~/.config/.local/bin/sys-update.sh && sleep 5 && shutdown now"  # Update and shutdown
