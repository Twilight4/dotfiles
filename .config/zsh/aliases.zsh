...
alias w='cd "$HOME/desktop" ; echo "$(hip) in $PWD" ; sudo python3 -m http.server 80'
alias ce='cheat --edit'
alias cl='clear ; lsd -l --hyperlink=auto'
alias w2='cd "$HOME/desktop" ; echo "$(hip) in $PWD" ; sudo python3 -m http.server 8000'
...
alias river="nvim ~/.config/river/init"
