...
alias fan-boost-on='sudo bash -c "echo 0 > /sys/devices/platform/hp-wmi/hwmon/hwmon*/pwm1_enable"'
alias fan-boost-off='sudo bash -c "echo 2 > /sys/devices/platform/hp-wmi/hwmon/hwmon*/pwm1_enable"'
