...
export PATH=$HOME/.config/hypr/scripts:$HOME/.local/bin:$HOME/.config/.local/share/cargo/bin:$HOME/.config/.local/bin:$HOME/.config/zsh/bash-scripts:$HOME/.config/rofi/applets/bin:$HOME/.config/rofi/launcher:$HOME/.config/rofi/wifi:$HOME/.config/node_modules/.bin:$PATH
...
# Nnn
export NNN_BMS="d:~/documents;D:~/downloads;w:~/desktop/workspace;h:~/.config/hypr;m:~/music;p:~/pictures;c:~/.config;v:~/videos;s:~/.config/.local/share/navi/cheats/Twilight4;o:/opt;r:/run/media/twilight"
export NNN_TRASH=1
