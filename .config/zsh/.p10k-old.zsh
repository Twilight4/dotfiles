...
() {
  ...
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_FOREGROUND=43
  # Text and color for visual vi mode.
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING="VISUAL "
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_FOREGROUND=069
  # Text and color for overtype (a.k.a. overwrite and replace) vi mode.
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING="OVERTYPE "
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_FOREGROUND=63
  # Text and color for insert vi mode.
  typeset -g POWERLEVEL9K_VI_INSERT_MODE_STRING="INSERT "
  typeset -g POWERLEVEL9K_VI_MODE_INSERT_FOREGROUND=123
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=104
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%023F[%039F%n@%m%023F]-'
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%023F[%075F%n@%m%023F]-%039F '
