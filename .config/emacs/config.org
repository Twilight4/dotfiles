...
;; Alert interval
(setq org-alert-interval 300              ;; how often org-alert checks your agenda file (300 seconds)
...
;; Custom titles
(setq org-alert-notification-title "Emacs Agenda")  ;; org-alert uses the title *org* by default
#+end_src
