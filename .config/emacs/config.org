...
(with-eval-after-load 'evil
  ;; Unbind the default prefix key "C-w"
...
;; Evil PageUp fix
(with-eval-after-load 'evil
  ;; Map "C-u" to "Page Up" in Evil normal state
  (define-key evil-normal-state-map (kbd "C-u") 'evil-scroll-up)
  ;; Map "C-u" to "Page Up" in Evil visual state
...
(global-set-key (kbd "M-h") #'org-up-element)                    ; default g h
(global-set-key (kbd "M-j") #'org-forward-heading-same-level)    ; default g j
(global-set-key (kbd "M-k") #'org-backward-heading-same-level)   ; default g k
(global-set-key (kbd "M-l") #'org-down-element)                  ; default g l
;; Org promote/demote headings
(global-set-key (kbd "M-H") #'org-metaleft)                      ; default M-<left>
(global-set-key (kbd "M-J") #'org-metadown)                      ; default M-<down>
(global-set-key (kbd "M-K") #'org-metaup)                        ; default M-<up>
(global-set-key (kbd "M-L") #'org-metaright)                     ; default M-<right>
...
(general-define-key
 ...
 "C-h" '(evil-window-split :wk "Horizontal split window")
 ...
 ;; Maximize window
 "C-m" '(toggle-maximize-evil-split :wk "Maximize buffer")
)
#+end_src
...
(use-package org-modern
  ...
  (setq org-modern-star '("◉" "○" "◆" "●" "○" "◆" "●")
        ...
        org-modern-list '((45 . "➤")   ; first level
                          (43 . "-")   ; second level
                          (42 . "•"))  ; third level
