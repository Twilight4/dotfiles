...
(general-define-key
 ...
 "K" '(avy-kill-whole-line :wk "Org timestamp")
 "Y" '(avy-copy-line :wk "Org timestamp")
 "n" '(avy-next :wk "Org timestamp")
 "p" '(avy-prev :wk "Org timestamp")
 "r" '(avy-resume :wk "Resume a fucking mark")
 "t" '(avy-transpose-lines-in-region :wk "Transpose lines in region")
 "." '(avy-goto-stamp :wk "Org timestamp"))
)
#+end_src
