...
(use-package god-mode
  ...
  (define-key god-local-mode-map (kbd "g") #'beginning-of-buffer)     ;; Replacing the default 'g' - Meta key in god mode
  (define-key god-local-mode-map (kbd "G") #'end-of-buffer)           ;; Replaceing the default 'G' - Ctrl+Meta key in god mode
  ...
  (define-key god-local-mode-map (kbd "C-h") #'kill-region-or-backward-delete)
  ...
  ;; Ctrl+Shift keys
  (define-key god-local-mode-map (kbd "C-S-f") #'tl-forward-word)
  (define-key god-local-mode-map (kbd "C-S-b") #'tl-backward-word)
...
(use-package goto-chg
  ...
  (global-set-key (kbd "M-u") 'goto-last-change-reverse))
#+end_src
