...
(defun tl/kill-copy-whole-line ()
  ...
  (let ((line-text (buffer-substring-no-properties
    ...
    (unless (zerop (length line-text))
      (let ((process-connection-type nil)) ; Ensure synchronous process execution
        (start-process "wl-copy" nil "wl-copy" line-text)))
    (kill-whole-line)
...
#+begin_src emacs-lisp
(defvar my-selection-mode nil
  "Variable to keep track of selection mode status.")

(defun toggle-selection-mode ()
  "Toggle selection mode."
  (interactive)
  (setq my-selection-mode (not my-selection-mode))
  (if my-selection-mode
      (progn
    ...
    (progn
      ...
      (message "Selection mode disabled"))))

(global-set-key (kbd "C-SPC") 'toggle-selection-mode)
#+end_src
...
(defun tl/create-org-buffer ()
  "Create a new Org mode buffer and switch to it."
  (interactive)
