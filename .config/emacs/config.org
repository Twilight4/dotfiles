...
(global-set-key (kbd "M-u") 'org-kill-line)
(global-set-key (kbd "M-h") 'treemacs)
(global-set-key (kbd "C-u") 'tl/org-kill-line-backward)
(global-set-key (kbd "M-n") 'tl/newline-at-end-of-line)
(global-set-key (kbd "C-f") 'forward-word)
(global-set-key (kbd "C-b") 'backward-word)
(global-set-key (kbd "C-p") 'org-backward-sentence)
(global-set-key (kbd "C-n") 'org-forward-sentence)
...
(defun kill-region-or-forward-delete ()
  ...
  (if (region-active-p)
      (progn
        ...
        (message "Copied to clipboard")
        (delete-region (region-beginning) (region-end)))
    (call-interactively 'smart-hungry-delete-forward-char)))
...
(use-package god-mode
  ...
  (define-key god-local-mode-map (kbd "C-S-j") #'join-line)
  (define-key god-local-mode-map (kbd "C-S-d") #'tl/kill-copy-whole-line)
  (define-key god-local-mode-map (kbd "C-S-a") #'consult-org-heading)
  (define-key god-local-mode-map (kbd "C-S-e") #'consult-mark)
  ...
  (define-key god-local-mode-map (kbd "C-S-h") #'treemacs)
  (define-key god-local-mode-map (kbd "C-S-m") #'org-meta-return)
  (define-key god-local-mode-map (kbd "C-}") #'tl/delete-to-end-of-file)
  (define-key god-local-mode-map (kbd "C-{") #'tl/delete-to-beginning-of-file)
  ;(define-key god-local-mode-map (kbd "C-S-k") #')
  ;(define-key god-local-mode-map (kbd "C-S-u") #')
  (define-key god-local-mode-map (kbd "C-S-l") #'mc/mark-next-like-this)
  ...
  (define-key god-local-mode-map (kbd "C-~") #'tl/toggle-letter-case)
  ...
  (define-key god-local-mode-map (kbd "C-|") #'query-replace)
