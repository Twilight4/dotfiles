...
(with-eval-after-load 'evil
  ...
  ;; Unbind the default bindings in normal mode
...
;; for a mode and sometimes only this method works but I believe it's better to use define-key for evil
;; mode cuz it's more precise
...
(with-eval-after-load 'evil
  ...
  ;; Bind S-h/j/k/l to TODOs/priorities
...
(general-define-key
 ...
 "T" '(org-transclusion-mode :wk "Org Tansclusion mode")
 ;; Specific Org Mode commands
 "C-t" '(org-todo :wk "Org todo")
 "C-i" '(org-toggle-item :wk "Org toggle item")
 "C-l" '(org-insert-link :wk "Org insert link")
 "C-f" '(org-insert-file-link :wk "Org insert file link")
 "C-o" '(org-open-at-point :wk "Org open thing at point")
