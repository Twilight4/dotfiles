...
;;   "dh"  `(,(tl/dired-link "~") :which-key "Home")
;;   "dn"  `(,(tl/dired-link "~/documents/org") :which-key "Notes")
;;   "do"  `(,(tl/dired-link "~/downloads") :which-key "Downloads")
;;   "dp"  `(,(tl/dired-link "~/pictures") :which-key "Pictures")
;;   "dv"  `(,(tl/dired-link "~/videos") :which-key "Videos")
;;   "d."  `(,(tl/dired-link "~/.config") :which-key ".config")
