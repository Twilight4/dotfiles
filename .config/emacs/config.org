...
(global-set-key (kbd "C-S-y") 'scroll-up-line)
(global-set-key (kbd "C-S-e") 'scroll-down-line)
;; Maximize window
(global-set-key (kbd "M-m") 'toggle-window-maximize)
;; Rebinding join-line
(global-set-key (kbd "C-n") 'join-line)
...
(with-eval-after-load 'evil
  ...
  ;; Rebinding default keybind of "C-E" for evil scroll-down
  ;(define-key evil-normal-state-map (kbd "C-R") 'evil-scroll-line-down)
...
(global-set-key (kbd "M-p") 'tl/better-next-buffer)
(global-set-key (kbd "M-n") 'tl/better-previous-buffer)
