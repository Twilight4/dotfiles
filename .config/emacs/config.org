...
(with-eval-after-load 'ox-latex
  (let* ((article-sections '(("\\section{%s}" . "\\section*{%s}")
         ...
         (book-sections (append '(("\\chapter{%s}" . "\\chapter*{%s}"))
                                article-sections))
         (hanging-secnum-preamble "YOUR_LATEX_HANGING_SECNUM_PREAMBLE_HERE")
         (big-chap-preamble "YOUR_LATEX_BIG_CHAPTER_PREAMBLE_HERE"))
...
(setq org-latex-tables-booktabs t
      org-latex-hyperref-template "YOUR_LATEX_FANCY_HYPERREF_TEMPLATE_HERE"
