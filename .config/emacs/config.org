...
(defconst tl/workspace-recipes
  '((agenda
    ...
    (work
     ...
     ("cli-2" . (lambda () (tl/ghostel-new-named "ghostel-2")))
...
(use-package ghostel
  ...
  ;; Keybindings - pass through terminal
  ...
  ;(define-key ghostel-semi-char-mode-map (kbd "ESC") #'ghostel--send-event)
  ;; Custom Keybindings
