...
(defun open-org-agenda-frame ()
  "Open a new frame with a custom Org Super Agenda overview."
  (interactive)
  (let ((agenda-frame (make-frame)))
    (select-frame-set-input-focus agenda-frame)
    (with-selected-frame agenda-frame
      (require 'org-super-agenda) ; Make sure org-super-agenda is loaded
      (org-agenda nil "o")))) ; Use "o" to directly select your custom command
#+end_src
