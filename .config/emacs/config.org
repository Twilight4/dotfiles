...
(use-package god-mode
  ...
  ;; EXPERIMENTING, free keys: C-d, C-u
  ...
  (define-key god-local-mode-map (kbd "C-S-d") #'mark-whole-line)
  (define-key god-local-mode-map (kbd "C-d") #'join-line)
  (define-key god-local-mode-map (kbd "C-t") #'zap-to-char)
