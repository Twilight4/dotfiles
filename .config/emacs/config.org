...
(use-package god-mode
  ...
  ;(define-key god-local-mode-map (kbd "i") #'god-local-mode)          ;; Quit god mode - rebinded to toggle god mode on TAB
  ...
  ;(define-key god-local-mode-map (kbd "C-S-w") #'tl/copy-current-line)

  ;; Ctrl+d
  (define-key god-local-mode-map (kbd "d") #'kill-region-to-clipboard)
  (define-key god-local-mode-map (kbd "C-d") #'kill-word)
  ;(define-key god-local-mode-map (kbd "C-S-d") #'tl/kill-current-line)
  ...
  ;; Undo/Redo
  (define-key god-local-mode-map (kbd "u") #'undo-only)
  (define-key god-local-mode-map (kbd "o") #'undo-redo)
  ...
  (define-key god-local-mode-map (kbd "C-@") #'consult-mark)
  (define-key god-local-mode-map (kbd "C-S-v") #'mark-whole-line)
  (define-key god-local-mode-map (kbd "C-S-r") #'rectangle-mark-mode)    ;; Backspace to delete, 't' to replace chars
  ...
  (define-key god-local-mode-map (kbd "g") #'keyboard-escape-quit)
