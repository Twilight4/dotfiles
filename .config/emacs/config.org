...
(use-package god-mode
  ...
  (define-key god-local-mode-map (kbd "C-S-h") #'mc/mark-next-like-this)
  (define-key god-local-mode-map (kbd "C-S-j") #'tl/copy-down-current-line-or-region)
  ...
  (define-key god-local-mode-map (kbd "C-S-b") #'tl/select-block)
...
(defun tl/copy-whole-line ()
  ...
  (let ((line-text (buffer-substring-no-properties
                    (line-beginning-position)
                    (line-end-position))))
    (when (zerop (call-process "wl-copy" nil nil nil line-text))
      (message "Line copied to clipboard."))))
...
(with-eval-after-load 'org
  ...
  (add-to-list 'org-structure-template-alist '("tf" . "src terraform :tangle yes"))
