...
(use-package general
  ...
  (tl/leader-keys
    ...
    "C-n" '(tl/better-previous-buffer :wk "Previous Buffer")
    "C-p" '(tl/better-next-buffer :wk "Next Buffer")
...
(use-package gptel
  ...
  (setq gptel-model   'google/gemini-2.0-pro-exp-02-05:free
       ...
       (gptel-make-openai "OpenRouter"               ; Any name you want
         ...
         :stream t
         :key "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"        ; Can be a function that returns the key
