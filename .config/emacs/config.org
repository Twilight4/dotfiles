...
(global-set-key (kbd "M-S-h") #'org-up-element)                    ; default g h
(global-set-key (kbd "M-S-j") #'org-forward-heading-same-level)    ; default g j
(global-set-key (kbd "M-S-k") #'org-backward-heading-same-level)   ; default g k
(global-set-key (kbd "M-S-l") #'org-down-element)                  ; default g l
;; Org move headings
...
(general-create-definer tl/leader-keys
  ...
  (tl/leader-keys
    ...
    "b m" '(toggle-maximize-evil-split :wk "Maximize buffer"))
