...
(use-package general
  ...
  (tl/leader-keys
    ...
    "f q" '(+rss/quit :wk "Quit")
	  "f e" '(elfeed-update :wk "Update")
	  "f r" '(elfeed-search-untag-all-unread :wk "Untag all unread")
	  "f u" '(elfeed-search-tag-all-unread :wk "Tag all unread")
	  "f s" '(elfeed-search-live-filter :wk "Filter")
	  "f S" '(elfeed-show-new-live-search :wk "New search")
	  "f RET" '(elfeed-search-show-entry :wk "Show entry")
	  "f P" '(elfeed-show-pdf :wk "Show pdf")
	  "f =" '(elfeed-search-tag-all :wk "Tag all")
	  "f -" '(elfeed-search-untag-all :wk "Untag all")
	  "f +" '(elfeed-show-tag :wk "Show tagged")
	  "f _" '(elfeed-show-untag :wk "Show untagged")
	  "f f" '(elfeed-search-set-filter :wk "Set filter")
	  "f b" '(elfeed-search-browse-url :wk "Browse url")
	  "f y" '(elfeed-search-yank :wk "Yank search")
	  "f Y" '(elfeed-show-yank :wk "Show yank")
	  ;"f q" '(+rss/delete-pane :wk "Delete pane")
	  "f o" '(ace-link-elfeed :wk "Ace link")
	  "f a" '(org-ref-elfeed-add :wk "Org-ref add")
	  "f n" '(elfeed-show-next :wk "Next")
	  "f p" '(elfeed-show-prev :wk "Previous")
	  "f R" '(tl/elfeed-update-and-notify :wk "Trigger the update and notification")    
	  "f D" '(tl/elfeed-download-video :wk "Download video from elfeed using yt-dlp"))
