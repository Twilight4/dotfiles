...
(with-eval-after-load 'evil
  ...
  (define-key evil-motion-state-map (kbd "C-q") nil)
  (define-key evil-motion-state-map (kbd "C-y") nil)
  (define-key evil-motion-state-map (kbd "C-w") nil)
  (define-key evil-motion-state-map (kbd "M-y") nil)
...
** Maximize-evil-split
Function for toggling maximization of evil split.
...
(defun toggle-window-maximize ()
  "Toggle maximization of the current evil split window."
  (interactive)
