...
- [[#editing-features][Editing Features]]
  ...
  - [[#move-cursor-by-text-block][Move cursor by text block]]
...
(global-set-key (kbd "C-a") 'tl/beginning-of-line-or-block)
(global-set-key (kbd "C-q") 'yaml-indent-line)
(global-set-key (kbd "C-e") 'tl/end-of-line-or-block)
...
#+begin_src emacs-lisp
(defun tl/beginning-of-line-or-block ()
...
(use-package god-mode
  ...
  (define-key god-local-mode-map (kbd "a") #'tl/beginning-of-line-or-block)
  (define-key god-local-mode-map (kbd "e") #'tl/end-of-line-or-block)
