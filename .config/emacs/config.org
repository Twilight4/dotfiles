  ...
  (let* ((projects
         ...
         (default-directory
          (cdr (assoc (completing-read "OMP project: "
                      ...
                      projects))))
    ;; agent-shell-start ignores agent-shell-prefer-viewport-interaction; force viewport after.
    (let ((shell-buffer (agent-shell-start :config (tl/agent-shell-omp-make-config))))
