...
;; Neotree
;(global-set-key (kbd "M-i") 'neotree-toggle)    ; Prefix key
...
(general-define-key
 :prefix "M-i"
 ;; Expand-region
 "M-w" '(er/mark-word :wk "Mark word")
 "M-h" '(er/mark-symbol :wk "Mark symbol")
 "M-H" '(er/mark-symbol-with-prefix :wk "Mark symbol with prefix")
 "M-a" '(er/mark-next-accessor :wk "Mark next accessor")
 "M-c" '(er/mark-method-call :wk "Mark method call")
 "M-q" '(er/mark-inside-quotes :wk "Mark inside quotes")
 "M-Q" '(er/mark-outside-quotes :wk "Mark outside quotes")
 "M-j" '(er/mark-inside-pairs :wk "Mark inside pairs")
 "M-J" '(er/mark-outside-pairs :wk "Mark outside pairs")
 "M-k" '(er/mark-comment :wk "Mark comment")
 "M-u" '(er/mark-url :wk "Mark URL")
 "M-e" '(er/mark-email :wk "Mark email")
 "M-d" '(er/mark-defun :wk "Mark defun")
 "M-l" '(er/mark-sentence :wk "Mark defun")
 "M-L" '(er/mark-paragraph :wk "Mark defun")
 ;; Symbol-overlay
 "P" '(symbol-overlay-put :wk "Symbol put")
 "n" '(symbol-overlay-jump-next :wk "Symbol jump next")
 "p" '(symbol-overlay-jump-prev :wk "Symbol jump prev")
 "f" '(symbol-overlay-switch-forward :wk "Symbol switch forward")
 "b" '(symbol-overlay-switch-backward :wk "Symbol switch backward")
 "R" '(symbol-overlay-remove-all :wk "Symbol remove all")
 "s" '(symbol-overlay-save-symbol :wk "Symbol save")
 "t" '(symbol-overlay-toggle-in-scope :wk "Symbol toggle in scope")
 "e" '(symbol-overlay-echo-mark :wk "Symbol echo mark")
 "d" '(symbol-overlay-jump-to-definition :wk "Symbol jump to definition")
 "i" '(symbol-overlay-query-isearch-literally :wk "Symbol isearch")
 "r" '(symbol-overlay-query-replace :wk "Symbol query replace")
 "N" '(symbol-overlay-rename :wk "Symbol rename"))
)
#+end_src
...
;; Emacs will not create new window splits either horizontally or vertically. Instead, it will reuse existing windows as much as possible
