...
(use-package general
  ...
  (tl/leader-keys
    ...
    ;"" '(org-gtd-engage-grouped-by-context :wk "Organized agenda")
    ;"" '(org-gtd-review-area-of-focus :wk "org-gtd-review-area-of-focus")
    ;"" '(org-gtd-engage :wk "GTD agenda")
    ;"" '(org-gtd-oops :wk "Missed appointments")
    ;"" '(org-gtd-review-stuck-* :wk "Any action types")
