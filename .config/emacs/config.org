...
(general-define-key
 ...
 "C-h" '(org-set-effort :wk "Org toggle heading")
...
(general-create-definer tl/leader-keys
  ...
  (tl/leader-keys
    ...
    "e r" '(lambda () (interactive) (find-file "~/documents/org/agenda/repeaters.org"))
...
#+begin_src emacs-lisp
  (setq org-capture-templates
    `(("t" "Tasks / Projects")
      ("tt" "Task" entry (file+olp "~/documents/org/agenda/inbox.org" "Inbox")
           "* TODO %?\n  %U\n  %a\n  %i" :empty-lines 1)

      ("j" "Journal Entries")
      ("jj" "Journal" entry
           (file+olp+datetree "~/documents/org/agenda/journal.org")
      ...
      ("w" "Workflows")
      ("we" "Checking Email" entry (file+olp+datetree "~/documents/org/agenda/journal.org")
           "* Checking Email :email:\n\n%?" :clock-in :clock-resume :empty-lines 1)

      ("m" "Metrics Capture")
      ("mw" "Weight" table-line (file+headline "~/documents/org/agenda/metrics.org" "Weight")
