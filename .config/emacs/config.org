...
;(global-set-key (kbd "C-M-m") 'gptel-send)
...
(use-package gptel
 ...
 ;; Set custom desired prompts are using =gptel-request=.
 (gptel-request
 "my prompt"
 :system "Respond ..."
...
Keyboard macros to invoke specific options from =gptel-menu=.
#+begin_src emacs-lisp
;; Replace with your key to invoke the transient menu:
(keymap-global-set "<f6>" "M-g C-c <return> <return>")
#+end_src
