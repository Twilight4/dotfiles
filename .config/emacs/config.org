...
- [[#editing-features][Editing Features]]
  ...
  - [[#upgraded-clipboard][Upgraded clipboard]]
...
(global-set-key (kbd "C-w") 'kill-region-or-backward-delete)
(global-set-key (kbd "C-d") 'kill-region-or-forward-delete)
(global-set-key (kbd "M-w") 'kill-ring-save-or-backward-kill-word)
;; Zooming keys
...
#+begin_src emacs-lisp
;; Package for conciceness when using C-p/n
...
(defun kill-ring-save-or-backward-kill-word ()
  "Wrapper for `kill-ring-save' or `backward-kill-word' depending on whether a region is active."
  (interactive)
  (if (region-active-p)
