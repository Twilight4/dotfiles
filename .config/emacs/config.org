...
(use-package general
  ...
  (tl/leader-keys
    ...
    "C-k" '(other-window :wk "Switch window")
    "C-j" '(previous-multiframe-window :wk "Select macro to run")
    ...
    "C-/" '(split-window-below :wk "Split window below")    ;; it's not a mistake, it's for god-mode
    "C-_" '(split-window-below :wk "Split window below")    ;; it's not a mistake, it's for god-mode
    "/" '(balance-windows :wk "Balance windows")
    ";" '(split-window-right :wk "Split window right")
    "C-;" '(split-window-right :wk "Split window right"))
