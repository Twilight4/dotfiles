...
(use-package gptel
  ...
  (setq gptel-default-mode 'org-mode))
		;(setq gptel-directives '("~/desktop/workspace/dotfiles/.config/ai-prompts/improve_prompt.md"
		;                        "~/desktop/workspace/dotfiles/.config/ai-prompts/create_npc.md"
		;                        "~/desktop/workspace/dotfiles/.config/ai-prompts/extract_videoid.md")))

;(setf (alist-get 'org-mode gptel-prompt-prefix-alist) "**** ")
#+end_src

GPTel directives, find more prompts [[https://github.com/f/awesome-chatgpt-prompts][here]].
#+begin_src emacs-lisp
        ...
        ,@(let ((res))
            (pcase-dolist (`(,sym ,filename)
                           '((improve_prompt "improve_prompt.md")
                             ...
                             (rate_content.md "rate_content.md")
                             (get_youtube_rss.md "get_youtube_rss.md"))
                           res)
