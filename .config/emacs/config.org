...
(define-key org-mode-map (kbd "M-T") 'org-ctrl-c-ctrl-c)
...
(setq org-agenda-files
      '("~/documents/org/agenda/inbox.org"   ;; REMOVE IT CUZ I USE org-gtd-tasks.org instead
        "~/documents/org/agenda/workflow.org" ;; DO NOTHING WITH IT
...
(use-package org-gtd
  ...
  (org-gtd-areas-of-focus '("Home" "Health" "Family" "Career" "Jebac"))
  (org-edna-use-inheritance t)
  (org-gtd-organize-hooks '(org-gtd-set-area-of-focus org-set-tags-command)) ;; TO ADD EFFORT HOOK 
  :config
  (org-edna-mode)
  :bind
