...
If the file has a =PROPERTY: header-args: terraform= for terraform docs, it will auto tangle after saving code terraform code blocks.
...
;; CAPE — dictionary-based “predictive” completion (more expanded dictionary config)
;; (use-package cape
;;  :ensure t
;;  :config
;;  ;; Use system dictionary (edit if different on your OS)
