...
(use-package general
  ...
  (tl/leader-keys
    ...
    "r" '(consult-register :wk "Load register and jump to location or insert the stored text")
    ;; Bookmarks
...
(use-package god-mode
  ...
  (define-key god-local-mode-map (kbd "C-S-r") #'rectangle-mark-mode)    ;; Backspace to delete, 't' to replace chars TODO
  ...
  ;; Misc
  (define-key god-local-mode-map (kbd "r") #'undo)
