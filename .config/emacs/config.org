...
;; Free keys: Z Y u l s a v
(eval-after-load 'org-agenda
  '(progn
     (define-key org-agenda-mode-map (kbd "B") 'org-save-all-org-buffers)
     ...
     (define-key org-agenda-mode-map (kbd "V") 'org-agenda-bulk-action)
     ...
     (define-key org-agenda-mode-map (kbd ">") 'org-agenda-view-mode-dispatch)
...
(use-package general
  ...
  (tl/leader-keys
    ...
    "C-h C-I" '(info :wk "Enter info, the documentation browser")
    "C-h C-e" '(info-emacs-manual :wk "Display emacs manual in info mode")
    "C-h C-E" '(info-display-manual :wk "Display info buffer displaying MANUAL")
    "C-h C-m" '(describe-mode :wk "Display documentation of current modes")
