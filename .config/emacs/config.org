...
** General Keybindings
#+begin_src emacs-lisp
  ;; In order to overwrite default keybinds first we need to disable default ones and then load the custom ones
    (global-unset-key (kbd "C-x C-]"))
    (global-unset-key (kbd "C-x C-["))

    (global-unset-key (kbd "C-x C-ESC"))
    (global-unset-key (kbd "C-x C-DEL"))
    (global-unset-key (kbd "C-x C-SPC"))
    (global-unset-key (kbd "C-x C-RET"))
    (global-unset-key (kbd "C-x C-TAB"))
  ...
  (use-package general
    ...
    (tl/leader-keys
      ...
      "<escape>" '(next-buffer :wk "Next buffer")
      "C-]" '(previous-buffer :wk "Previous buffer")
      "b r" '(revert-buffer :wk "Reload buffer"))

    (tl/leader-keys 
      "C-e" '(eval-region :wk "Evaluate elisp in region"))
  )
#+end_src
