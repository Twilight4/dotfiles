...
(setq org-roam-capture-templates
  '(("d" "default" plain "%?"
      ...
      :unnarrowed t)
	  ("l" "Logbook Template" plain
     (file "~/documents/org/templates/logbook/new-logbook.org")
     :if-new (file "~/documents/org/reports/${slug}_logbook.org")
     :unnarrowed t)
    ("r" "Report Templates")
...
(defun tl/log-quick-entry ()
  ...
  (let ((current-date-time (format-time-string "%Y-%m-%d %I:%M %p")))
    (end-of-line)
    (insert-file-contents "$HOME/documents/org/templates/logbook/log-quick-entry.org")
    (next-line)
