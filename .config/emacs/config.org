...
(use-package general
  ...
  (tl/leader-keys
    ...
    "C-f C-d" '(org-timer-stop :wk "Stop timer")
    "C-f C-i" '(org-timer-item :wk "Timer item")
    "C-f C-p" '(org-timer-pause-or-continue :wk "Pause/Continue timer")
    ;; Timeclock
    "C-f C-m" '(timeclock-mode-line-display :wk "Display work time on modeline")
    "C-f C-u" '(timeclock-in :wk "Work start")
...
(with-eval-after-load 'treemacs
  ...
  (treemacs-modify-theme "Default"
    ...
    (progn
      ...
      ;; js / ts
      (treemacs-create-icon :icon (propertize " " 'face '(:foreground "#cbcb41")) :fallback (propertize " " 'face '(:foreground "#cbcb41")) :extensions ("js" "mjs" "cjs"))
