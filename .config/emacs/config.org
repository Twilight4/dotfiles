...
(with-eval-after-load 'org
  (define-key org-mode-map (kbd "C-x n b") nil)   ;; org-narrow-to-block
  (define-key org-mode-map (kbd "C-x n s") nil)   ;; org-narrow-to-subtree
  (define-key org-mode-map (kbd "C-x n e") nil))  ;; org-narrow-to-element
...
(use-package general
  ...
  (tl/leader-keys
    ...
    "RET" '(toggle-window-maximize :wk "Toggle window maximization")
...
(defun tl/agent-shell-omp-start ()
  ...
  (interactive)
  (require 'agent-shell)
  (agent-shell--dwim :config (tl/agent-shell-omp-make-config)
                     :new-shell t))
...
(use-package ghostel
  ...
  (define-key ghostel-semi-char-mode-map (kbd "M-m") #'toggle-window-maximize)
...
*** olivetti
I use Olivetti to center =org-mode= buffers for centering the contents of the buffer horizontally to seem more like you are editing a document.

#+begin_src emacs-lisp
(use-package olivetti
  :hook ((org-mode . olivetti-mode)
         (org-agenda-mode . tl/org-agenda-olivetti))
  :config
  (setq-default olivetti-body-width 0.85)
  (remove-hook 'olivetti-mode-on-hook 'visual-line-mode)
  
  (defun tl/org-agenda-olivetti ()
    (setq-local olivetti-body-width 0.45)
    (olivetti-mode 1)))
#+end_src
