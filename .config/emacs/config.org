...
(global-set-key (kbd "M-a") 'org-backward-paragraph)
(global-set-key (kbd "M-e") 'org-forward-paragraph)
(global-set-key (kbd "M-.") 'org-forward-sentence)
(global-set-key (kbd "M-,") 'org-backward-sentence)
