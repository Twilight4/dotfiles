...
(global-set-key (kbd "C-x w") 'winner-mode)
...
(use-package general
  ...
  (tl/leader-keys
    ...
    "t" '(org-table-create :wk "Create new org table")
    ...
    "w" '(winner-undo :wk "Undo window change")
  ...
  (tl/leader-keys
    ...
    "C-t C-j" '(global-hl-line-mode :wk "Toggle line highlight globally"))
...
(add-to-list 'org-after-todo-state-change-hook
             (lambda ()
               (when (or (equal org-state "FINISHED")
