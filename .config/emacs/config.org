...
(define-key calendar-mode-map "D" 'diary-show-all-entries)
...
(define-key calendar-mode-map "M" 'calendar-mark-holidays)
...
(use-package gptel
  ...
  (setq gptel-model   'deepseek-chat
       ...
       (gptel-make-openai "DeepSeek"               ; Any name you want
         ...
         :stream t
         :key "sk-49a7bb8ae1bb46438c89beaac53ddfb7"        ; Can be a function that returns the key
