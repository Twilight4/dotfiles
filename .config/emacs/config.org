...
(general-define-key
 ...
 "C-j" '(org-insert-file-link :wk "Org insert file link")
 ...
 "C-v" '(org-narrow-to-subtree :wk "Narrow to subtree")
 ;"C-" '(org-narrow-to-block :wk "Narrow to block")
 "C-f" '(tl/org-narrow-forward :wk "Narrow forward")
 "C-b" '(tl/org-narrow-backward :wk "Narrow backward")
 "C-g" '(widen :wk "Widen")
 ...
 "C-q" '(org-show-current-heading-tidily :wk "Focus current heading hiding other ones")
