...
#+begin_src emacs-lisp
;; Set up 'M-SPC' as another global leader key
(general-create-definer tl/leader-keys
  :prefix "M-SPC") ;; Set leader key
  ...
  (which-key-add-key-based-replacements "M-SPC ." "Find file")
  ...
  (which-key-add-key-based-replacements "M-SPC e c" "Edit config"
                                        "M-SPC e s" "Edit emacs cheatsheet")
)
#+end_src
