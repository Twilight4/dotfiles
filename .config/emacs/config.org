...
- [[#editing-features][Editing Features]]
  ...
  - [[#clipboard-automation][Clipboard automation]]
  - [[#selection-automation][Selection automation]]
...
;; Generate TOC with 4 headlines by default
(setq org-export-with-toc t)
(setq org-export-with-toc-depth 4)

;; Show only 3 levels of TOC on startup
...
(setq desktop-restore-eager 1)                    ; Restore 1 buffer eagerly (immediatelly), this can impact startup performance
