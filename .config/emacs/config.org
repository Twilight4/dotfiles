...
- [[#other-packages][Other Packages]]
  ...
  - [[#pdf-tools][Pdf-tools]]
  - [[#org-noter][Org-noter]]
  - [[#org-pdftools-and-org-noter-pdftools][Org-pdftools and org-noter-pdftools]]
...
#+begin_src emacs-lisp
;; Global Keybindings
;; Optionally available keybinds: M-r M-i C-z C-t
...
;;(global-set-key (kbd "M-w") 'kill-ring-save)        ; set by default
...
(use-package general
  ...
  (tl/leader-keys
    ...
    ;; Dired bookmarks
    "d H"  `(,(tl/dired-link "~") :which-key "Home")
    "d R"  `(,(tl/dired-link "~/documents/org/roam") :which-key "Org Roam")
    "d D"  `(,(tl/dired-link "~/downloads") :which-key "Downloads")
    "d P"  `(,(tl/dired-link "~/pictures") :which-key "Pictures")
    "d V"  `(,(tl/dired-link "~/videos") :which-key "Videos")
    "d C"  `(,(tl/dired-link "~/.config") :which-key ".config")) 
