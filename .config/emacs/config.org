...
(use-package general
  ...
  (tl/leader-keys
    ...
    ;; Timer
    "C-f C-t" '(org-timer-set-timer :wk "Set timer")
    "C-f C-a" '(org-timer-start :wk "Start timer")
    "C-f C-m" '(org-timer-stop :wk "Stop timer")
    "C-f C-u" '(org-timer-item :wk "Timer item")
    "C-f C-p" '(org-timer-pause-or-continue :wk "Pause/Continue timer")
    ;; Timeclock
...
;(global-set-key (kbd "M-u") 'tl/jinx-auto-correct)
