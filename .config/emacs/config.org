...
(use-package general
  ...
  (tl/leader-keys
    ...
    "C-d C-o" '((lambda () (interactive) (dired "~/downloads/")) :wk "Open user-emacs-directory in dired")
    "C-d C-p" '((lambda () (interactive) (dired "~/pictures/")) :wk "Open user-emacs-directory in dired")
    "C-d C-s" '((lambda () (interactive) (dired "~/pictures/screenshots")) :wk "Open user-emacs-directory in dired")
    "C-d C-w" '((lambda () (interactive) (dired "~/desktop/workspace")) :wk "Open user-emacs-directory in dired")
    "C-d C-c" '((lambda () (interactive) (dired "~/.config")) :wk "Open user-emacs-directory in dired")
    "C-d C-i" '((lambda () (interactive) (dired "~/documents")) :wk "Open user-emacs-directory in dired")
    "C-d C-m" '((lambda () (interactive) (dired "~/music")) :wk "Open user-emacs-directory in dired")
    "C-d C-v" '((lambda () (interactive) (dired "~/video")) :wk "Open user-emacs-directory in dired"))
...
(defun tl/copy-current-word ()
  "Copy the current word including special characters to the kill-ring and display it."
  (interactive)
...
(use-package agent-shell
   ...
   :bind (:map agent-shell-mode-map
               ...
               ;("C-." . agent-shell-next-item)
               ;("C-," . agent-shell-previous-item)
               ;("C-c C-f" . agent-shell-fork)
               ;("C-c C-s" . agent-recall-consult-search)
               ;("C-c C-b" . agent-recall-browse)
               ;("C-c C-r" . agent-recall-resume)
               ;("C-c C-w" . tl/agent-shell-copy-session-id)
               ;("C-c r" . agent-shell-resume-session)
               ;("C-c C-e" . agent-shell-restart)
               ;("C-c C-h" . comint-show-maximum-output)
               ;("C-c h" . comint-show-output)
               ;("C-c C-v" . agent-shell-set-session-config-option)
               ;("C-c v" . agent-shell-set-session-model)
               ;("C-c s" . shell-maker-save-output)
               ;("C-c C-q" . agent-shell-queue-request)
               ;("C-c C-g" . comint-clear-buffer)
               ;("C-c C-a" . tl/agent-shell-toggle-auto-accept)
...
(defun tl/copy-to-end-of-file ()
  ...
  (let ((text-to-copy (buffer-substring-no-properties
    ...
    (when (zerop (call-process "wl-copy" nil nil nil text-to-copy))
