...
(use-package expand-region
  :bind (("M-C w" . er/mark-word)
		 ("M-C s" . er/mark-symbol)
		 ("M-C S" . er/mark-symbol-with-prefix)
		 ("M-C a" . er/mark-next-accessor)
		 ("M-C c" . er/mark-method-call)
		 ("M-C q" . er/mark-inside-quotes)
		 ("M-C Q" . er/mark-outside-quotes)
		 ("M-C p" . er/mark-inside-pairs)
		 ("M-C P" . er/mark-outside-pairs)
		 ("M-C c" . er/mark-comment)
		 ("M-C u" . er/mark-url)
		 ("M-C e" . er/mark-email)
		 ("M-C d" . er/mark-defun)))
#+end_src
