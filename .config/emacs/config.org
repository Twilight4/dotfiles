...
(use-package god-mode
  ...
  (define-key god-local-mode-map (kbd "a") #'org-beginning-of-line)
  (define-key god-local-mode-map (kbd "e") #'org-end-of-line)
  ...
  ;; Unbound
  ;(define-key god-local-mode-map (kbd "C-S-b") #')
  ;(define-key god-local-mode-map (kbd "g") #')
