
						  ("https://www.youtube.com/feeds/videos.xml?channel_id=UCthRsjtSd2ZTrfgjgnBXMPw" youtube UnixGuy Cyber Security Career)
						  ("https://www.youtube.com/feeds/videos.xml?channel_id=UChH3vLF7j8PlgSTtOB9adJA" youtube Upgrade Security)
						  ("https://www.youtube.com/feeds/videos.xml?channel_id=UCKONdcQCTP3aozARj1ntKhw" youtube warpdotdev)
						  ("https://www.youtube.com/feeds/videos.xml?channel_id=UCWsdOwuIUInJwyXxI9j_Adw" youtube Yaniv Hoffman)
						  ("https://www.youtube.com/feeds/videos.xml?channel_id=UCVPjtOVcnKaSRI8IO3KSetA" youtube zSecurity)))))
...
;; From newly uploaded videos feeds in elfeed, have them downloaded if desired
(defun tl/elfeed-download-video ()
  "Download a video using yt-dlp."
  (interactive)
  (let* ((yt-dlp-command "/usr/bin/yt-dlp --restrict-filenames -f 22 -P ~/videos/elfeed-youtube -o \"%(title)s.%(ext)s\"")
         (link (elfeed-entry-link elfeed-show-entry))
         (command (format "%s %s" yt-dlp-command link)))
...
;; Function to update elfeed feeds and show desktop notifications for new entries
(defun tl/elfeed-update-and-notify ()
  "Update elfeed feeds and show desktop notifications for new entries."
  (interactive)
  (elfeed-update)
  (let ((new-entries (elfeed-search-unread-unenclosed)))
    (when new-entries
      (let ((notification-body (format "You have %d new Elfeed entries." (length new-entries))))
        (call-process "notify-send" nil nil nil "--urgency=normal" "--expire-time=5000" "New Elfeed Entries" notification-body)))))

;; Hook to update feeds and show notifications after updating
;(add-hook 'elfeed-search-update-hook #'tl/elfeed-update-and-notify)

;; Function to run the update and notify function every 5 minutes if the elfeed buffer is open
;(defun tl/elfeed-auto-update ()
;  "Run `tl/elfeed-update-and-notify' every 5 minutes if the elfeed buffer is open."
;  (when (get-buffer-window "*elfeed-search*")
;    (tl/elfeed-update-and-notify)))

;; Run the function every 5 minutes
;(run-with-timer 0 (* 5 60) 'tl/elfeed-auto-update)


(require 'url)

(defvar elfeed-pdf-dir
  (expand-file-name "pdfs/" "~/documents/org/elfeed/"))
...
(defun elfeed-show-pdf (entry)
  ...
  (let ((link (elfeed-entry-link entry))
    ...
    (let ((file (expand-file-name
                 (concat (replace-regexp-in-string "/" "," title) ".pdf")
                 (expand-file-name (replace-regexp-in-string "/" "," feed-name)
                                   elfeed-pdf-dir))))
...
(use-package elfeed-score
  ...
  (progn
    (elfeed-score-enable)
    (define-key elfeed-search-mode-map "0" elfeed-score-map)))
#+end_src
...
(use-package org-alert
  ...
  (setq alert-default-style 'libnotify      ;; get system notifications
		  ...
		  org-alert-notify-after-event-cutoff 10  ;; controls how long after a scheduled event to continue sending notifications - 10 minutes
...
;org-modern-progress nil      ;; Disable modern proggress icon
;org-modern-priority nil      ;; Disable modern priorities
#+end_src
