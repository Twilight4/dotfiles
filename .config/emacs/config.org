...
#+begin_src emacs-lisp
(defun kill-region-to-clipboard ()
...
(global-set-key (kbd "C-c b") 'tl/org-insert-template-and-paste)
...
(use-package god-mode
  ...
  ;; (define-key god-local-mode-map (kbd "C-S-h") #'mc/mark-next-like-this)         ;; not using at the moment
  ...
  ;; Ctrl+w
  (define-key god-local-mode-map (kbd "w") #'copy-to-system-clipboard)
  (define-key god-local-mode-map (kbd "C-w") #'backward-kill-word)
  (define-key god-local-mode-map (kbd "C-S-w") #'tl/copy-whole-line)

  ;; Ctrl+d
  (define-key god-local-mode-map (kbd "d") #'kill-region-to-clipboard)
  ...
  (define-key god-local-mode-map (kbd "C-S-v") #'mark-whole-line)
  ...
  (define-key god-local-mode-map (kbd "y") #'paste-from-system-clipboard)
