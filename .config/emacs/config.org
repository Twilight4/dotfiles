...
(global-set-key (kbd "C-x r") 'consult-register)
;; Movement keys
...
(use-package gptel
  ...
  ;(global-set-key (kbd "C-M-r") 'gptel--suffix-rewrite)    ; command unavailable
  ;(global-set-key (kbd "C-x e") 'gptel--rewrite-directive-menu)      ;; Select directive for rewrite - commadn aunabailable
  ;(global-set-key (kbd "C-x n") 'gptel--rewrite-next)    ; keybind taken
  ...
  ;(global-set-key (kbd "C-c t") 'gptel-org-set-topic)        ; keybind taken
  ;(global-set-key (kbd "C-c e") 'gptel--suffix-system-message)   ;; I don't use it
  (global-set-key (kbd "C-v r") 'gptel--mark-response)

  ;; Response options
  ;(global-set-key (kbd "C-x r") 'gptel--regenerate)    ; keybind taken
 ; (global-set-key (kbd "C-x f") 'gptel--next-variant)    ; keybind taken
