...
(use-package gptel
 ...
 ;(setq gptel-default-mode org-mode)          ;; WRONG SYNTAX

 ;; TODO Set custom desired prompts are using =gptel-request=.
										;(gptel-request
 ;"my prompt"
 ;:system "Respond ..."
 ;:callback (lambda (response info)
 ;            "Whatever LLM RESPONSE."
 ;            (frob response))))
#+end_src
...
#+begin_src emacs-lisp
;; Prompt from
(keymap-global-set "C-M-o" "M-g M-RET m RET")
(keymap-global-set "C-M-e" "M-g M-RET y RET")
(keymap-global-set "C-M-a" "M-g M-RET i RET")

;; Response to
(keymap-global-set "C-M-d" "M-g M-RET e RET")
;(keymap-global-set "C-M-x" "M-g M-RET b *scratch* RET RET")
(keymap-global-set "C-M-g" "M-g M-RET g RET RET")
;(keymap-global-set "C-M-g" "M-g M-RET g RET RET")

;; Normal keybinds
(global-set-key (kbd "M-RET") 'gptel-send) ;
(global-set-key (kbd "C-M-c") 'gptel)       ;; TODO bind it to kitty session instead of shellgpt
;(global-set-key (kbd "M-RET") 'gptel-mode)   ;; not useful - gptel automates it
(global-set-key (kbd "M-\\") 'gptel-abort)
(global-set-key (kbd "C-M-l") 'gptel-org-set-topic)
...
(global-set-key (kbd "M-'") 'gptel--suffix-system-message)
(global-set-key (kbd "C-M-u") 'gptel-system-prompt)
#+end_src
