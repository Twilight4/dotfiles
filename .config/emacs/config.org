...
(general-define-key
 ...
 "i" '(avy-goto-char-in-line :wk "Jump to a character in line")	; UNSURE
 ...
 "s" '(avy-goto-subword-1 :wk "Jump to a subword") ; UNSURE
 "." '(avy-goto-stamp :wk "Jump to stamp")	   ; UNSURE
 "o" '(avy-org-goto-heading-timer :wk "Jump to org heading") ; UNSURE
 "p" '(avy-pop-mark :wk "Pop a fucking mark")		     ;UNSURE
 "i" '(avy-isearch :wk "iSearch")			     ;UNSURE
