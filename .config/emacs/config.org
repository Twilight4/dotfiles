...
(define-key global-map (kbd "C-<down>") nil)
(define-key global-map (kbd "M-<left>") nil)
(define-key global-map (kbd "M-<left>") nil)
(define-key global-map (kbd "M-<right>") nil)
(define-key global-map (kbd "M-<right>") nil)
...
(use-package god-mode
  ...
  ;(define-key god-local-mode-map (kbd "C-S-e") #')
  ;(define-key god-local-mode-map (kbd "C-S-a") #')
