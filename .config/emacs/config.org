...
(setq bibtex-completion-bibliography
      '("~/documents/bibliography/bibtex-file-1.bib"
        "~/documents/bibliography/bibtex-file-2.bib"))

;; Basic configuration
;; PDF files
(setq bibtex-completion-library-path '("~/documents/bibliography/pdfs" "~/documents/bibliography/pdfs"))
