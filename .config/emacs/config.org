...
(global-set-key (kbd "C-M-o") 'backward-kill-sentence)
(global-set-key (kbd "C-M-u") 'kill-sentence)
;; Spelling
...
#+begin_src emacs-lisp
;; Keybinds that can't be set cuz they're bugged in 'gptel-menu': 'm' 'b'
...
(global-set-key (kbd "M-\\") 'gptel-abort)   ;; 'M-'' is available

;; Other
(global-set-key (kbd "C-M-l") 'gptel-system-prompt)
(global-set-key (kbd "C-M-o") 'gptel--suffix-system-message)
