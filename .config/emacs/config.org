...
;; Org agenda
(define-key org-mode-map "N" 'tl/org-agenda-new)
(define-key org-mode-map "x" 'tl/org-agenda-done)
(define-key org-mode-map "X" 'tl/org-agenda-mark-done-and-add-followup)
;;(define-key org-agenda-mode-map "N" 'tl/org-agenda-new)
;;(define-key org-agenda-mode-map "x" 'tl/org-agenda-done)
;;(define-key org-agenda-mode-map "X" 'tl/org-agenda-mark-done-and-add-followup)
...
(general-create-definer tl/leader-keys
  ...
  (tl/leader-keys
    ...
    "e n" '(lambda () (interactive) (counsel-find-file "~/documents/org/roam/permanent-notes"))
         ...
         (
          ...
          (tags-todo "TODO=\"NEXT\""
                     ((org-agenda-overriding-header "Next to do")
                      (org-agenda-files org-agenda-files)))
          (tags-todo "+PRIORITY=\"A\"+TAG=\"Important\""
