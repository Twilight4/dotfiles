...
- [[#editing-features][Editing Features]]
  ...
  - [[#toggle-split-window-maximization][Toggle Split Window Maximization]]
  - [[#splits][Splits]]
...
(with-eval-after-load 'evil
  ...
  ;; Unbinding the default bindings in normal/visual mode
...
(with-eval-after-load 'evil
  ...
  ;; Keybindings for org mode in evil normal mode for TODOs/priorities
...
(general-define-key
 ...
 "C-m" '(bookmark-set :wk "Set/Delete bookmark")
 "C-s" '(bookmark-save :wk "Save current bookmarks to bookmark file"))
...
(general-define-key
 ...
 "T" '(org-transclusion-mode :wk "Org Transclusion mode")
 "C-." '(org-time-stamp :wk "Org timestamp")
 "C-/" '(counsel-org-tag :wk "Org tag")
 ...
 "c" '(completion-at-point :wk "Complete node-insert at point")
 "i" '(org-id-get-create :wk "Insert id for Org heading")
 "g" '(org-roam-graph :wk "Show Org roam graph")
 "n" '(org-roam-capture :wk "Capture to node")
)
#+end_src
...
(general-create-definer tl/leader-keys
  ...
  (tl/leader-keys
    ...
    "s" '(org-todo-list :wk "Org todo list")
    "c" '(org-capture :wk "Capture something")
  ...
  (tl/leader-keys
    ...
    "h r" (lambda () (interactive) (load-file "~/.config/emacs/init.el")))

  (which-key-add-key-based-replacements "SPC h r" "Reload emacs")
  ...
  (tl/leader-keys
    ...
    "o b" '(create-new-org-buffer :wk "Create new org buffer")
    "o t" '(insert-auto-tangle-tag :wk "Insert auto-tangle tag")
  ...
  (tl/leader-keys
    ...
    "r r" '(counsel-register :wk "Interactively choose a register")
  ...
  (tl/leader-keys
    ...
    "e i" '(lambda () (interactive) (find-file "~/documents/org/agenda/inbox.org"))
...
that it automatically tangles when you save the document.
...
*** Auto-tangle automation
I have made adding =org-auto-tangle= to files easier.
...
(setq org-capture-templates
  `(("t" "Todo" entry (file+olp "~/documents/org/agenda/inbox.org" "Inbox")
         "* TODO %?\n  %U\n  %a\n  %i" :empty-lines 1)

    ("j" "Journal" entry (file+olp+datetree "~/documents/org/agenda/journal.org")
         "\n* %<%I:%M %p> - Journal :journal:\n\n%?\n\n"
         ;; ,(dw/read-file-as-string "~/Notes/Templates/Daily.org")
         :clock-in :clock-resume
         :empty-lines 1)

    ("m" "Meeting" entry (file+olp+datetree "~/documents/org/agenda/journal.org")
         "* %<%I:%M %p> - %a :meetings:\n\n%?\n\n"
         :clock-in :clock-resume
         :empty-lines 1)

    ("w" "Workflow" entry (file+olp+datetree "~/documents/org/agenda/journal.org")
  ...
  (org-roam-capture-templates
   '(("d" "default" plain "%?"
     ...
     ("b" "book notes" plain
      ...
      :if-new (file+head "${slug}.org" "#+title: ${title}\n#+date: %U\n")
      :unnarrowed t)))
     ;("t" "template name" plain
     ; (file "~/documents/org/templates/template.org")
     ; :if-new (file+head "${slug}.org" "#+title: ${title}\n#+date: %U\n")
     ; :unnarrowed t)))
  :config
  (org-roam-setup))
...
(setq org-capture-templates
      '(("c" "Characteristics" entry
         (file+headline "~/documents/org/roam/templates.org" "Characteristics")
         "* Characteristics\n\n- Family:\n- Inspired by:\n\n* Reference")))
#+end_src
