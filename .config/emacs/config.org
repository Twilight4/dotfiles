...
This package provides access to hyperlinks, notes, attachments and the source bibliography file. Citar also integrates with =org-cite=, Org mode’s citation module.
...
that and avoid the description prompt.
