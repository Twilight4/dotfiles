...
(use-package org-fancy-priorities
  ...
  (setq
    ...
    org-priority-faces
    '((?A :foreground (face-foreground 'all-the-icons-red) :weight bold)
      (?B :foreground (face-foreground 'all-the-icons-orange) :weight bold)
      (?C :foreground (face-foreground 'all-the-icons-yellow) :weight bold))))
#+end_src
