...
(global-set-key (kbd "M-q") 'scroll-up-line)
...
(general-define-key
 ...
 "i" '(avy-goto-char-in-line :wk "Jump to a character in line")
 ...
 "s" '(avy-goto-subword-1 :wk "Jump to a subword")
 "." '(avy-goto-stamp :wk "Jump to stamp")
 "o" '(avy-org-goto-heading-timer :wk "Jump to Org heading")
 "p" '(avy-pop-mark :wk "Pop a fucking mark")
 "i" '(avy-isearch :wk "iSearch")
 ;; yanking/killing/moving
 "k" '(avy-kill-region :wk "Kill region")
 "y" '(avy-kill-ring-save-region :wk "Copy region")
 "y" '(avy-kill-ring-save-whole-line :wk "Copy region")
 ...
 "r" '(avy-resume :wk "Resume a fucking mark")
