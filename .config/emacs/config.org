...
(set-face-attribute 'line-number nil :background "#040305" :foreground "#434850" :slant 'italic)
...
;; Divider
(set-face-attribute 'vertical-border nil :foreground "#bfbdb6")  ; or any terminal color
...
;; Text color of org code blocks - not working
;(set-face-attribute 'org-code nil :foreground "#CDD6F4")
