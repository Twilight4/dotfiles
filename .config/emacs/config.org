...
(use-package general
  ...
  (tl/leader-keys
    ...
    "i" '(org-gtd-process-inbox :wk "Process inbox")  ;; process inbox.org
...
(use-package gptel
  ...
  ;; TODO Send request - change keybindings to work in god-mode
  ...
  (global-set-key (kbd "C-x C-b") 'gptel--previous-variant)
)
#+end_src
...
(use-package hl-todo
  ...
  (define-key hl-todo-mode-map (kbd "C-x C-j") #'hl-todo-next)
  (define-key hl-todo-mode-map (kbd "C-x C-k") #'hl-todo-previous))
#+end_src
