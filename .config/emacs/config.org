...
** Color Theme
Taking a look at the [screenshots](https://github.com/doomemacs/themes/tree/screenshots) might help you decide which one you like best. You can run `M-x counsel-load-theme` to choose between them easily.
#+begin_src emacs-lisp
;; Theme
