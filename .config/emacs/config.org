...
(use-package hl-todo
  ...
  (setq hl-todo-highlight-punctuation ":"
        ...
        `(("TODO"       warning bold)
          ("DOING"      success bold)
          ("NEXT"       warning bold)
          ("SOMEDAY"    font-lock-constant-face bold)
          ("DONE"       success bold)
          ("WAIT"       font-lock-doc-face bold)
          ("REVIEW"     success bold)
          ("PLAN"       font-lock-keyword-face bold)
          ("BACKLOG"    font-lock-keyword-face bold)
          ("READY"      font-lock-constant-face bold)
          ("NOW"        success bold)
...
(setq org-capture-templates
  `(("t" "Todo" entry (file+olp "~/documents/org/agenda/inbox.org")
    ...
    ("w" "Workflow" entry (file+olp+datetree "~/documents/org/agenda/workflow.org")
