...
(general-define-key
 :prefix "C-;"
 ;; Org-mode
 "c" '(avy-goto-char :wk "Org timestamp")
 "C" '(avy-goto-char-2 :wk "Org timestamp")
 "l" '(avy-goto-line :wk "Org timestamp")
 "w" '(avy-goto-word-1 :wk "Org timestamp")
 "W" '(avy-goto-word-2 :wk "Org timestamp")
 "W" '(avy-goto-subword-1 :wk "Org timestamp")
 "W" '(avy-goto-subword-0 :wk "Org timestamp")
 "a" '(avy-goto-line-above :wk "Org timestamp")
 "b" '(avy-goto-line-below :wk "Org timestamp")
 "p" '(avy-pop-mark :wk "Org timestamp")
 "r" '(avy-resume :wk "Org timestamp")
 "i" '(avy-isearch :wk "Org timestamp")
 "a" '(avy-avy-org-refile-as-child :wk "Org timestamp")
 "o" '(avy-org-goto-heading-timer :wk "Org timestamp"))
