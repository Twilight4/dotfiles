...
(keymap-global-set "C-M-l" "M-g ESC RET k RET")      ;; Run 'M-'' to copy it to system clipboard
...
;; Other
;(global-set-key (kbd "C-M-") 'gptel-system-prompt)              ;; BIND IT
;(global-set-key (kbd "C-M-") 'gptel--suffix-system-message)     ;; BIND IT
