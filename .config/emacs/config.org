...
(use-package general
  ...
  (tl/leader-keys
    "C-s" '(:ignore t :wk "Help")
    "C-s C-h" '(help-for-help :wk "Get help")
    "C-s C-i" '(Info-goto-emacs-command-node :wk "Go to info mode in emacs MANUAL for command")
    "C-s C-o" '(info :wk "Enter info, the documentation browser")
    "C-s C-e" '(info-emacs-manual :wk "Display emacs manual in info mode")
    "C-s C-q" '(info-display-manual :wk "Display info buffer displaying MANUAL")
    "C-s C-d" '(describe-mode :wk "Display documentation of current modes")
    "C-s C-f" '(describe-function :wk "Describe function")
    "C-s C-k" '(describe-key-briefly :wk "Describe key briefly")
    "C-s C-v" '(describe-variable :wk "Describe key briefly")
    "C-s C-l" '(describe-key :wk "Describe key")
    "C-s C-c" '(describe-command :wk "Describe command")
    "C-s C-r" '((lambda () (interactive)
...
(use-package god-mode
  ...
  (define-key god-local-mode-map (kbd "C-s") #'tl/search-current-word)
