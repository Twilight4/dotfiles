...
| C-c RET    | agent-shell-set-session-mode          |
| C-c C-t    | agent-shell-set-session-thought-level |
| C-c v      | agent-shell-set-session-config-option |
| C-c C-v    | agent-shell-set-session-model         |
| C-c C-c    | agent-shell-interrupt                 |
| C-c C-a    | toggle auto-confirming questions      |
...
| C-c C-a    | gptel-end-of-response       |
| C-c C-e    | gptel-beginning-of-response |
...
| C-M-i      | gptel-rewrite from directive message |
