...
** Agent-shell
Agent-shell global keymaps:
| Keybinding | Description                                           |
|------------+-------------------------------------------------------|
| C-x SPC    | start OMP agent-shell (pick project)                  |
...
OMP Viewport buffers:
| Keybinding | Description                           |
|------------+---------------------------------------|
| M-r        | Prompts history                       |
| C-p/n      | Previous/next input history           |
| C-c C-l    | Show output last message in view-mode |
| C-c C-s    | agent-recall-consult-search           |
| C-c C-b    | agent-recall-browse                   |
| C-c RET    | Set session mode                      |
| C-c C-v    | agent-shell-set session-model         |
| C-c C-t    | agent-shell-set thought level         |
| C-c C-q    | agent-shell-queue-request             |
| C-c C-e    | agent-shell-restart                   |
| C-c C-f    | agent-shell-fork                      |
| C-c C-c    | agent-shell compose send/interrupt    |
...
| s          | set mode                              |
| t          | set thought level                     |
| l          | Show output last message in view-mode |
| ;          | recenter                              |
| </>        | beginning/end of buffer               |
...
| C-M-n      | respond from minibuffer to current buffer |
