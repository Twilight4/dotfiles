...
| SPC        | Set mark                                            |
| m/M        | Mark diary entries/holidays                         |
...
| u          | Unmark holidays and diary entries                   |
...
| M-u        | Upcase-word                                                  |
| M-l        | Downcase-word                                                |
| C-c M-f    | Org next code block                                          |
| C-c M-b    | Org previous code block                                      |
| M-a        | Embark act                                                   |
| M-n        | Treemacs                                                     |
| M-i        | jinx-correct                                                 |
...
| ,             | backward-paragraph                   |
| .             | forward-paragraph                    |
| >             | mark-to-end-of-paragraph             |
| <             | mark-to-beginning-of-paragraph       |
| e             | org-end-of-line                      |
...
| \             | universal-argument                   |
| S-i           | tl/org-cycle-or-shift-tab            |
| S-q           | goto-last-change                     |
| S-o           | goto-last-change-reverse             |
| ;             | recenter-top-bottom                  |
| :             | move-to-window-line-top-bottom       |
| t             | zap-up-to-char                       |
| u             | tl/newline-at-end-of-line            |
| S-d           | org-babel-mark-block                 |
| S-s           | er/mark-symbol                       |
| S-u           | mark-whole-line                      |
| ~             | capitalize-word                      |
| "Pipe symbol" | gptel-abort                          |
| S-v           | join-line                            |
| S-w           | tl/copy-down-current-line-or-region  |
| S-z           | surround-bold                        |
| S-x           | surround-italic                      |
| S-c           | surround-code                        |
