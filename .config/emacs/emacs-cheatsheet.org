...
| u/R/U/K/F/L/T   | Toggle diary/clock/deadlines/habits/follow mode/log mode/time grid |
...
| O          | Use find to display files by name      |
| C-o        | use find to display files by grep      |
