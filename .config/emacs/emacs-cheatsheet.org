...
| Keybinding  | Description                                           |
|-------------+-------------------------------------------------------|
| C-x SPC     | start OMP agent-shell (pick project: linux/devops)    |
| C-\ C-x SPC | start OMP agent-shell with arbitrary CWD              |
| M-v         | agent-shell-switch-buffer                             |
| C-x j       | switch to agent awaiting reply                        |
| C-\ C-x j   | switch to agent awaiting reply from all active agents |
...
Oh-My-Pi chat buffer:
| Keybinding | Description                                 |
|------------+---------------------------------------------|
| M-r        | Prompts history                             |
| C-,/.      | Previous/next item                          |
...
Agent-shell-browse command (transcript mode):
| Keybinding | Description                            |
|------------+----------------------------------------|
...
| key   | command                    | action                       |
|-------+----------------------------+------------------------------|
| C-x v | mcp-hub                    | View mcp hub server          |
| s     | mcp-hub-start-server       | Start server at cursor       |
| k     | mcp-hub-close-server       | Stop server at cursor        |
| r     | mcp-hub-restart-server     | Restart server at cursor     |
| S     | mcp-hub-start-all-server   | Start all configured servers |
| R     | mcp-hub-restart-all-server | Restart all servers          |
| K     | mcp-hub-close-all-server   | Stop all servers             |
| l     | mcp-hub-view-log           | View a server's log          |
