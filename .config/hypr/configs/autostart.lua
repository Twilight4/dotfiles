...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd([[sleep 2 && hyprctl dispatch 'hl.dsp.focus({window="class:^(kitty-cliamp)$"})' && sleep 0.5 && wtype V && sleep 0.3 && hyprctl dispatch 'hl.dsp.focus({workspace=1})' && sleep 0.3 && hyprctl dispatch togglespecialworkspace comma]])
