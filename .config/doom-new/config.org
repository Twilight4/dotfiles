#+title: Config
#+property: header-args :tangle configl.el

* Table Of Contents :toc:
- [[#theme][Theme]]
- [[#bookmark-keybinds][Bookmark keybinds]]
  - [[#enable-global-auto-revert][Enable global auto revert]]
  - [[#ibuffer-mode-keys][Ibuffer mode keys]]
- [[#fonts][Fonts]]
...
- [[#org-mode][Org mode]]
  ...
  - [[#org-fonts][Org fonts]]
  - [[#load-doom-theme-on-startup][Load doom theme on startup]]
